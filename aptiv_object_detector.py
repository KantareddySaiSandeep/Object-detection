...
# example:
#
# run command: python3 aptiv_object_detector.py --input_path "/home/mayank-s/PycharmProjects/Datasets/aptive/object_detect/input" --output_path "/home/mayank-s/PycharmProjects/Datasets/aptive/object_detect/output"
#
        ...
        for root,_, filenames in os.walk(input_folder):
            ...
            for filename in filenames:
                try:
                    ...
                    #cv2.imshow('berkley_validation',image)
                    #cv2.waitkey(2000)
                    # Clean up
...
def parse_args():
    ...
    parser.add_argument('--input_path', help="Input Folder", default='/home/sai-kantareddy/Downloads/bdd100k/images/100k/val')
